...
![Canny Edge](images/canny_edge.png) <!-- Ensure the image path is correct or provide the actual path -->
...
![Background Subtraction](images/background_subtraction.png) <!-- Ensure the image path is correct or provide the actual path -->
